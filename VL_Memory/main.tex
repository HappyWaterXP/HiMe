...
\twocolumn[
  ...
  Li Ji$^{1*}$ \quad
  Siyin Wang$^{1,2*}$ \quad
  Pengfang Qian$^{1,2}$ \quad
  Xiaopeng Yu$^{1}$ \\
  Yihai Tian$^{1,3}$ \quad
  Zhaoye Fei$^{1}$ \quad
  Jingjing Gong$^{2}$ \quad
  Xipeng Qiu$^{1,2}$
  \par}
  ...
  $^{3}$Software Engineering, East China Normal University, Shanghai, China
  \par}
